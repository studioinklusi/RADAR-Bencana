...
export const MobileBottomSheet: React.FC<MobileBottomSheetProps> = ({
  ...
  // Determine height classes based on snap point
  ...
  return (
    <div
      className={`fixed bottom-14 inset-x-0 z-30 md:hidden bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-2xl rounded-t-3xl flex flex-col overflow-hidden bottom-sheet-transition select-none ${getHeightStyle()}`}
    >
      ...
      <div
        ...
        onClick={toggleSnap}
        className="pt-2 px-4 pb-2 bg-slate-50/90 border-b border-slate-200/80 cursor-pointer shrink-0"
      >
        {/* Grab Pill Bar */}
      ...
      {/* Expanded Content (Visible when snapState === 'half' or 'full') */}
      {snapState !== 'peek' && (
        <div className="flex-1 flex flex-col overflow-hidden">
          {/* Mobile Tabs Switcher */}
          <div className="flex items-center border-b border-slate-200 bg-slate-100/70 p-1 gap-1 shrink-0">
            <button
              type="button"
